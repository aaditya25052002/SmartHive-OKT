                  ...
                  >
                    ...
                    >
                      <Link
                        ...
                        className="dark:border rounded-full px-6 py-2.5 dark:border-pink-600
                          dark:text-pink-600 dark:bg-transparent font-medium text-xs leading-tight
                          uppercase hover:border-pink-700 focus:border-pink-700
                          focus:outline-none focus:ring-0 active:border-pink-800
                          transition duration-150 ease-in-out text-white bg-pink-600"
                      >
                        View
                      </Link>
